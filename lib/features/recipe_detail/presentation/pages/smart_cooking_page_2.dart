...
class SmartCookingPage2 extends StatefulWidget {
  final List<String> steps;
  final String imageUrl;

  const SmartCookingPage2({
    super.key,
    required this.steps,
  ...
  @override
  State<SmartCookingPage2> createState() => _SmartCookingPageState();
}

class _SmartCookingPageState extends State<SmartCookingPage2> {
  int currentIndex = 0;
